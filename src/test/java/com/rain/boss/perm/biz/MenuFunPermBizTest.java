...
public class MenuFunPermBizTest extends AbstractTestClass {

    private static MenuFunPerm globalEntity;
    private static Collection<MenuFunPerm> globalEntitys;
    @Resource
    private MenuFunPermBiz biz;
