...
public class FieldResourceBizTest extends AbstractTestClass {

    private static FieldResource globalEntity;
    private static Collection<FieldResource> globalEntitys;
    @Resource
    private FieldResourceBiz biz;
