...
public class TableResourceBizTest extends AbstractTestClass {

    private static TableResource globalEntity;
    private static Collection<TableResource> globalEntitys;
    @Resource
    private TableResourceBiz biz;
