...
public class PositionFunPermBizTest extends AbstractTestClass {

    private static PositionFunPerm globalEntity;
    private static Collection<PositionFunPerm> globalEntitys;
    @Resource
    private PositionFunPermBiz biz;

    private static PositionFunPerm genEntity() {
