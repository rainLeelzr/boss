...
public class FunPermBizTest extends AbstractTestClass {

    private static FunPerm globalEntity;
    private static Collection<FunPerm> globalEntitys;
    @Resource
    private FunPermBiz biz;
