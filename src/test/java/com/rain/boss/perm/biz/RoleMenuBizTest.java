...
public class RoleMenuBizTest extends AbstractTestClass {

    private static RoleMenu globalEntity;
    private static Collection<RoleMenu> globalEntitys;
    @Resource
    private RoleMenuBiz biz;
