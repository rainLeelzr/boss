...
public class DataPermBizTest extends AbstractTestClass {

    private static DataPerm globalEntity;
    private static Collection<DataPerm> globalEntitys;
    @Resource
    private DataPermBiz biz;

    private static DataPerm genEntity() {
