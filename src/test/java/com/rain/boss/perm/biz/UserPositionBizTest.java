...
public class UserPositionBizTest extends AbstractTestClass {

    private static UserPosition globalEntity;
    private static Collection<UserPosition> globalEntitys;
    @Resource
    private UserPositionBiz biz;
