...
public class DataPermSetBizTest extends AbstractTestClass {

    private static DataPermSet globalEntity;
    private static Collection<DataPermSet> globalEntitys;
    @Resource
    private DataPermSetBiz biz;
